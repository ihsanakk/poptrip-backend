...
public interface PlaceRepository extends JpaRepository<Place,Integer> {
    ...
    @Query(value = "select new com.poptrip.controller.dto.ReviewDto(r.id,r.reviewText,r.createdAt,r.updatedAt, u.id,u.username, p.id, p.placeTitle,p.imageUrl) from Place p join p.reviews r join r.user u where p.id=:place_id")
